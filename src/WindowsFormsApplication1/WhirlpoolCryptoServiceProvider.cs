...
// Source: https://gist.github.com/SplittyDev/43ba394c18c4b86fef9b
...
namespace System.Security.Cryptography
{
    public class WhirlpoolCryptoServiceProvider : HashAlgorithm
    {
        ...
        #region implemented abstract members of HashAlgorithm
        ...
        protected override void HashCore (byte[] array, int ibStart, int cbSize) {
            NESSIE_Add (array, ibStart, cbSize);
        }

        protected override byte[] HashFinal () {
            var buffer = new byte[DIGEST_BYTES];
